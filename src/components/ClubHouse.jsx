...
import { Eye, Sparkles, Building, Maximize2 } from 'lucide-react';
    ...
    <section id="clubhouse" className="section-wrapper clubhouse-section" aria-label="Clubhouse Showcase">
      <div className="section-container">
        <div className="clubhouse-header-grid">
          <div>
            <span className="eyebrow-tag">RESORT-STYLE LIVING</span>
          ...
          <div className="clubhouse-intro-box">
            <p className="section-lead-text">
              Indulge in resort-style amenities at the Club House designed to enhance your well-being and offer a luxurious escape within your own community. Also enjoy a dedicated central park of 4.5 acres.
            </p>
            <div className="club-badge-row">
              <span className="pill-badge">90,000 S.ft Club House</span>
